...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Control del ojo de contraseña (SVG) - VERSIÓN MEJORADA
  document.querySelectorAll(".toggle-password").forEach(icon => {
    icon.addEventListener("click", () => {
      ...
      if (input.type === "password") {
        ...
        // Cambiar el icono a "ojo tachado" para indicar que está visible
        ...
        // Restaurar el icono original (ojo abierto)
  ...
  form.addEventListener("submit", async (e) => {
    ...
    const mm = String(hoy.getMonth() + 1).padStart(2, '0'); // CORREGIDO: +1 porque getMonth() devuelve 0-11
    ...
    try {
      ...
      if (usuarioCreado && usuarioCreado.data) {
        const historialData = {
          ...
          fecha: hoy.toISOString(), // CORREGIDO: usar toISOString()
